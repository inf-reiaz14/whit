...
use App\Http\Requests\skillitempagesStoreRequest;
use App\Http\Controllers\Controller;
use App\Skillitempage;

class Skillitempages extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.skillitempages.index', ['skillitempages'=> Skillitempage::latest()->paginate(20)]);
    ...
    public function searchIndex(Request $request)
    {
        ...
        return view('admin.skillitempages.index', ['skillitempages'=> $result->latest()->paginate(20)]);
    ...
    public function create()
    {
        ...
        return view('admin.skillitempages.create');
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(skillitempagesStoreRequest $request)
    {
        
        
        $request['link'] = str_slug($request->link_input);

        // DD($request->hasFile('banner_photos'));
        ...
        $save_success = Skillitempage::create($request->all());
        
        if($save_success){
        
            return redirect()->action('Skillitempages@index')->withErrors('Data has been stored successfully.');
    ...
    public function show($id)
    {
        ...
        $skillitempage = Skillitempage::find($id); 
        
        return view('admin.skillitempages.show', compact('skillitempage') );
    ...
    public function edit($id)
    {
        ...
        return view('admin.skillitempages.edit', compact('skillitempage') );
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(skillitempagesStoreRequest $request, $id)
    {
        $skillitempage = Skillitempage::find($id);
        ...
        if($request->has('banner_photo_delete'))
        {
            ...
            if($skillitempage->banner_photo)
            {
                
                $image_to_delete_lg = $skillitempage->banner_photo;
        ...
        $save_success = Skillitempage::find($id)->update($request->all());
        
        if($save_success)
        {
            return redirect()->action('Skillitempages@index')->withErrors('Data has been updated successfully.');
    ...
    public function destroy($id, Request $request)
    {
        ...
        if($skillitempage)
        {
            ...
            if($skillitempage->delete())
            {
            
                return redirect()->action('Skillitempages@index')->withErrors('Data has been deleted successfully.');
