...
Sizes: [
	...
	<head>
		...
		<title>Account activated at TeamSourcing (BD) | WebHawks IT Ltd, Bangladesh</title>
		<style type="text/css">
			/* RESET STYLES */
																			...
																			<tr>
																				<td align="left" class="textContent">
																					<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																						Account activated at TeamSourcing (Bangladesh)
																					</div>
																				</td>
																			</tr>
																		</table>
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">Awesome! Your account has been activated at TeamSourcing (BD)</h1>
																		<h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">Please login to make your team</h2>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
										...
										<tr>
											<td align="center" valign="top">
												<!-- FLEXIBLE CONTAINER // -->
												    ...
												    <h2 style="text-align:center; padding: 20px 0px; width:100%;">Your account will remain active for next 12 hours only.</h2>
