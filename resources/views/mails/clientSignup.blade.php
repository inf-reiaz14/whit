...
Sizes: [
	...
	<head>
		...
		<title>Successful sign up at TeamSourcing (BD) | WebHawks IT Ltd, Bangladesh</title>
		<style type="text/css">
			/* RESET STYLES */
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">Welcome to TeamSourcing (BD)</h1>
																		<h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">Your registration is successful</h2>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
										...
										<tr>
											<td align="center" valign="top">
												<!-- FLEXIBLE CONTAINER // -->
												    ...
												    <h2 style="text-align:center; padding: 20px 0px; width:100%;">Click on the link below to continue to your TeamSourcing (BD) account.</h2>
															...
															<table border="0" cellpadding="0" cellspacing="0" width="100%" class="emailButton" style="background-color: white;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;color:#666666; text-align:left; font-size: 14px;">
																		...
																		<p>password: Password that you provided during signup</p>
																		<p>Expiry in: 12hours from now</p>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
