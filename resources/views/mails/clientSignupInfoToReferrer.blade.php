...
Sizes: [
	...
	<head>
		...
		<title>You have a new client signed up at TeamSourcing (BD) | WebHawks IT Ltd, Bangladesh</title>
		<style type="text/css">
			/* RESET STYLES */
																			...
																			<tr>
																				<td align="left" class="textContent">
																					<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																						Your new client at TeamSourcing (BD)
																					</div>
																				</td>
																			</tr>
																		</table>
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td valign="top" bgcolor="#E1E1E1">
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																			<div>Copyright &#169; {{date('Y')}} <a href="http://www.webhawksit.com/" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">WebHawks IT LTD, Bangladesh.</span></a>. All&nbsp;rights&nbsp;reserved.</div>
																			<div>TeamSourcing (BD) is a concern of WebHawks IT ltd, Bangladesh.</div>
																		</div>
