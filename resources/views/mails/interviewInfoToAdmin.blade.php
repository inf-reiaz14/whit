...
Sizes: [
	...
	<head>
		...
		<title>New interview request at TeamSourcing (BD) | WebHawks IT Ltd, Bangladesh</title>
		<style type="text/css">
			/* RESET STYLES */
																			...
																			<tr>
																				<td align="left" class="textContent">
																					<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																						Welcome to TeamSourcing (Bangladesh)
																					</div>
																				</td>
																			</tr>
																		</table>
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">New Interview request</h1>
																		<h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">TeamSourcing (BD), WebHawks IT, Bangladesh</h2>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
										...
										<tr>
											<td align="center" valign="top">
												<!-- FLEXIBLE CONTAINER // -->
												    ...
												    <h2 style="text-align:center; padding: 20px 0px; width:100%;">Details of Interview request</h2>
															...
															<table border="0" cellpadding="0" cellspacing="0" width="100%" class="emailButton" style="background-color: white;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;color:#666666; text-align:left; font-size: 14px;">
																		...
																		<p>Address: {{$user->address}}, {{$user->city}}, {{$user->state}}, {{$user->country}}, {{$user->postcode}}</p>
																		<p>Industry type: {{$user->industry_type}}</p>
																		<p>Referrer: @if($referrer) {{$referrer->firstname}} {{$referrer->lastname}} | {{$referrer->business_name}} | {{$referrer->email}} @endif</p>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
															...
															<table border="0" cellpadding="0" cellspacing="0" width="100%" class="emailButton" style="background-color: white;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;color:#666666; text-align:left; font-size: 14px;">
																		...
																		<p>Interview schedule: {{$interview['interview_schedule']}}</p>
																		<p>Interview media: {{$interview['interview_media']}}</p>
																		<p>Interview request: {{$interview['interview_request']}}</p>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td valign="top" bgcolor="#E1E1E1">
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																			<div>Copyright &#169; {{date('Y')}} <a href="http://www.webhawksit.com/" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">WebHawksIT bangladesh ltd.</span></a>. All&nbsp;rights&nbsp;reserved.</div>
																			<div>TeamSourcing (BD) is a concern of WebHawksIT Bangladesh ltd.</div>
																		</div>
