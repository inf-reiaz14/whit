															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		...
																		<h2>
																			We have received new Internship Application.
																		</h2>
																	</td>
																</tr>
															</table>
															...
															<table border="0" cellpadding="0" cellspacing="0" width="100%" class="emailButton" style="background-color: white;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;color:#666666; text-align:left; font-size: 14px;">
																		...
																		<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="{{action('Interns@show', $intern->id)}}" target="_blank">Click here to view the application</a>
																		<p>Name: {{$intern->name}}.</p>
																		<p>DOB: {{$intern->dob}}.</p>
																		<p>Email: {{$intern->email}}.</p>
																		<p>Phone: {{$intern->phone}}.</p>
																		<p>Prefetch: {{$intern->prefetch}}.</p>
																		<p>Country: @if($intern->country){{$intern->country->name}} @endif.</p>
																		<p>Family member details: {{$intern->family_details}}.</p>
																		<p>Educational Background: {{$intern->education_background}}.</p>
																		<p>Aim in Life (English): {{$intern->aim_in_life_en}}.</p>
																		<p>Aim in Life (Natiive): {{$intern->aim_in_life_native}}.</p>
																		<p>Reason for interest in Career travel to BD (English): {{$intern->why_interested_in_carereer_travel_en}}.</p>
																		<p>Reason for interest in Career travel to BD (Natiive): {{$intern->why_interested_in_carereer_travel_native}}.</p>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td valign="top" bgcolor="#E1E1E1">
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																			<div>Copyright &#169; {{date('Y')}} <a href="http://www.webhawksit.com.bd/" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">WebHawksIT bangladesh ltd.</span></a>. All&nbsp;rights&nbsp;reserved.</div>
																		</div>
