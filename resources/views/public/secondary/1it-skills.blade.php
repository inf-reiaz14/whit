									...
									<div class="col-xs-12 framwork-holder transparent-bg green-border">
										...
										<div class="row">
											<div class="col-xs-12 transparent-bg btn-popups pull-down-20">
												<center>
													<a href="{{ action('StaticPageController@skillItemDetail', $skillitem->link) }}" class="btn btn-font btn-default transparent-bg blue-text green-border push-up-10">{{$skillitem->name}}</a>
												</center>
											</div>
										</div>
									</div>
