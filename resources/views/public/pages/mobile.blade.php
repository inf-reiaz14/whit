...
<html>
    <head>
        ...
        <style>
            ...
            .padding-top{padding-top: 10%;padding-bottom: 4%;}
    	...
    	<div class="container">
  			<div class="row padding-top">
  			    ...
  			    <div class="col-xs-12 text-center">
  			        @if( strlen( $application->prototype_mobile ) > 0 )
  			        <iframe width="420" height="545" src="{{ $application->prototype_mobile }}" frameborder="0" allowfullscreen></iframe>
  			        @else
