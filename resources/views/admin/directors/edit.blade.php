...
@section('title') Edit Director @stop

@section('main')

<h1 class="page-title blue-bg white-text"><center>Modify Director's Info</center></h1>
...
{!! Form::open( ['method'=>'patch', 'url'=> action('Directors@update', $advisor->id), 'enctype'=>'multipart/form-data' ]) !!}
            
            {!! Form::hidden('is_director', 1) !!}
    ...
    <div class="form-group">
        {!! Form::submit('Update Director', ['class'=>'form-control btn btn-info']) !!}
    </div>
